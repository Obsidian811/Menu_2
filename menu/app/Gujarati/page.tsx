...
import { getMenuItems, getCategoryItems } from '../lib/menu-data-guj';
...
const categories: { id: MenuCategory; name: string; icon: string }[] = [
  ...
  { id: 'cold-drinks', name: 'પીણાં', icon: '🥤' },
...
export default function GujaratiMenu() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8"> {/* Changed max-width for better single-column presentation */}
        <div className="grid grid-cols-1 gap-4"> {/* Changed to a single column grid */}
          ...
          {categoryItems.length === 0 && (
             <p className="text-center text-gray-400 py-10 text-lg">આ કેટેગરીમાં કોઈ વસ્તુઓ મળી નથી.</p>
          )}
        </div>
      </main>
